...
object SpecialtiesRow {
  inline val tableName = "PUBLIC.SPECIALTIES"
  inline val id = "ID"
...
case class SpecialtiesRow(ID: Int, NAME: Option[String]) derives SqlReadRow { def pk: SpecialtiesRow.PK = ID }
